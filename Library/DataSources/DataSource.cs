...
namespace PaJaMa.Database.Library.DataSources
{
    public abstract class DataSource : IDisposable
    {
        ...
        public DbConnection OpenConnection(string database = "")
        {
            ...
            else if (Connection.DataSourceType == typeof(MySqlDataSource).FullName || Connection.DataSourceType == typeof(MySqlDataSourceForCompare).FullName)
            {
            ...
            else if (Connection.DataSourceType == typeof(PostgreSQLDataSource).FullName)
            {
            ...
            connectionString += (string.IsNullOrEmpty(Connection.Append) ? "" : ";" + Connection.Append);
